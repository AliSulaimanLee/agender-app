package com.agender.app.modules.pertanyaankuis.`data`.model

import com.agender.app.R
import com.agender.app.appcomponents.di.MyApp
import kotlin.String

data class PertanyaanKuisModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtFrameEightyTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtFrame209: String? = MyApp.getInstance().resources.getString(R.string.lbl_jawab)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtFrame208: String? = MyApp.getInstance().resources.getString(R.string.lbl2)
